...
public interface ShamMotorController {
     ...
     * @param state the current state of the mechanism, this is the state <b>at the rotor</b>. If
     *     you wish to scale these states based on the gearbox ratio, you can do
