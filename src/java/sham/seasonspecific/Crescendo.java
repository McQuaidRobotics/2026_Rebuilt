    ...
    public static class CrescendoShamArena extends ShamArena {
        ...
        public static final class CrescendoFieldObstaclesMap extends FieldMap {
            ...
            public CrescendoFieldObstaclesMap() {
                ...
                // upper wall
                super.addBorderLine(
                        new Translation2d(0, 8.12), new Translation2d(FIELD_WIDTH, 8.12));
        ...
        // private static final Translation3d BLUE_SOURCE_POSITION = new Translation3d(15.6, 0.8,
        // 0.1);
        ...
        protected void competitionPeriodic() {
            ...
            // final Translation3d sourcePosition =
            // toCurrentAllianceTranslation(BLUE_SOURCE_POSITION);
            // /* if there is any game-piece 0.5 meters within the human player station, we don't
            // throw a
            // new note */
            // boolean gpNearSource =
            //     gamePieces.stream()
            //         .anyMatch(gp -> gp.pose().getTranslation().getDistance(sourcePosition) <
            // 0.6);
