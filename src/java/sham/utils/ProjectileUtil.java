...
public class ProjectileUtil {
    ...
    /**
     * Takes the time since last update, the current position, and the current velocity of a
     * projectile and returns the new velocity of the projectile.
     *
    ...
    public static ProjectileDynamics gravity(double g) {
        return (dt, velocity) -> {
            ...
            return new Velocity3d(
                    velocity.getVX(), velocity.getVY(), velocity.getVZ() + verticalDeceleration);
        };
    }
}
