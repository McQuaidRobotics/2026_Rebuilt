...
public class ShamMechanism {
     ...
     * etc.
     *
     * <p>It is sound behavior for this to capture outputs of other mechanisms but be aware the
     * order of calculations between mechanisms is not guaranteed. For example, if an inverse
     * pendulum mechanism could have extra load depending on the drive mechanism's acceleration, the
     * drive mechanism should be calculated first in the same time slot but this can not be
     * promised.
     */
    ...
    public record Friction(Torque staticFriction, Torque kineticFriction)
         ...
         * @return a {@link Friction} object with the same value for both static and kinetic
         *     friction
         */
    ...
    public record HardLimits(Angle minAngle, Angle maxAngle) implements StructSerializable {
        ...
        public static HardLimits unbounded() {
            return new HardLimits(
                    Rad.of(Double.NEGATIVE_INFINITY), Rad.of(Double.POSITIVE_INFINITY));
        }
    ...
    public record MechanismVariables(
        ...
        public static MechanismVariables of(
            ...
            return new MechanismVariables(
                    torque, voltage, supplyVoltage, statorCurrent, supplyCurrent);
        }
            ...
            variables =
                    MechanismVariables.of(
                            ...
                            motor.getSupplyCurrent(
                                    motorState().velocity(), voltageInput, motorCurrent));
        } finally {
