...
public class AbsoluteTargetAngleTool {
    ...
    /**
     * Calculates the absolute angle from the front of the robot to a specific AprilTag.
     * * @param currentTurretAngle The turret's current rotation relative to robot front.
