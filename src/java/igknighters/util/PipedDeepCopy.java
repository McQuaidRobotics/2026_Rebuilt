...
/**
 * Utility for making deep copies (vs. clone()'s shallow copies) of objects in a memory efficient
 * way. Objects are serialized in the calling thread and de-serialized in another thread.
 *
 * <p>Error checking is fairly minimal in this implementation. If an object is encountered that
 * cannot be serialized (or that references an object that cannot be serialized) an error is printed
 * to System.err and null is returned. Depending on your specific application, it might make more
...
public class PipedDeepCopy {
    ...
    private static class Deserializer extends Thread {
        ...
        /**
         * Returns the deserialized object. This method will block until the object is actually
         * available.
         */
