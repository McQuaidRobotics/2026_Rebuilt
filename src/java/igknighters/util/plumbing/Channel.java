...
public class Channel<T> {
        ...
        var r =
                (SafetyMarkedReceiver<T, TSM>)
                        new ReceiverBuffered<>(
                                this, makeBuffer(bufferSize), safetyMarker.threadSafe());
        addReceiver(r);
        return r;
    }
    ...
    /**
     * The receiving end of a channel, data can be extracted from it, specific behavior depends on
     * the chosen channel type.
     *
    ...
    public abstract static class Receiver<T> {
        ...
        /**
         * @return an optional containing the received value, or empty if the channel is empty,
        ...
        /**
         * @return the received value or the default value if the channel is empty, removing the
        ...
        /**
         * @return the received value or the default value if the channel is empty, without removing
        ...
        public <TSM extends ThreadSafetyMarker> SafetyMarkedReceiver<T, TSM> fork(
            ...
            var r =
                    (SafetyMarkedReceiver<T, TSM>)
                            new ReceiverBuffered<>(
                                    channel,
                                    channel.makeBuffer(bufferSize),
                                    safetyMarker.threadSafe());
            channel.addReceiver(r);
            return r;
        }
    }
    ...
    /**
     * The receiving end of a broadcast channel that stores all values in a circular buffer, can
     * hold up to specified number of values
     */
