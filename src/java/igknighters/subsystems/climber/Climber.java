...
public class Climber extends SubsystemBase {
    ...
    public void goToState(ClimberState state) {
        chainsaw.goToInches(state.positionInches);
        servos.goToAngleDegrees(state.upperServoAngleDegrees, Servos.ServoID.MOVING_SERVOS);
        servos.goToAngleDegrees(state.lowerServoAngleDegrees, Servos.ServoID.FIXED_SERVOS);
    }
