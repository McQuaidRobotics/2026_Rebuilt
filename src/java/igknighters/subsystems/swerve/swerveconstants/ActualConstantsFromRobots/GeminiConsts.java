package igknighters.subsystems.swerve.swerveconstants.ActualConstantsFromRobots;
...
public class GeminiConsts extends CommonSwerveConsts {
    ...
    public double getWheelDiameterMeters() {
        return kWheelRadius.in(Meter) * 2;
    }
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.1796875);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.44384765625);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.23193359375);
    ...
    // }
    @Override
    public CommandSwerveDrivetrain createDrivetrain(Subsystem requirement) {
        return new CommandSwerveDrivetrain(
