...
import yams.motorcontrollers.remote.TalonFXWrapper;
	...
	public class Rollers extends SubsystemBase {
	  ...
	  private SmartMotorController talonSmartMotorController = new TalonFXWrapper(roller, DCMotor.getKrakenX60(1), smcConfig);
	
	 private final FlyWheelConfig shooterConfig = new FlyWheelConfig(talonSmartMotorController)
	   ...
	   */
	  public Command targetVelocity(AngularVelocity speed) {return shooter.run(speed);}
