...
public class ClimberCommands {
     ...
     * @param state
     * @param timeSeconds
     * @return A command that goes to the specified state, holds it for the specified time, and then stops the climber
     */
    ...
    /**
     * Goes through the climb sequence: Climb Prep -> Latch On -> Pull Up, holding Pull up until the command is interrupted. Climb Prep is held for 2 seconds, and Latch On is held for 1 second.
     * @param climber
     * @return A command that goes through the climb sequence: Climb Prep -> Latch On -> Pull Up, holding Pull up until the command is interrupted. Climb Prep is held for 2 seconds, and Latch On is held for 1 second.
     */
    ...
    /**
     * Goes through the unclimb sequence: Pull Up -> Latch On -> Climb Prep -> Stow. Ends when climber reaches state of climb prep
     * @param climber
     * @return A command that goes through the unclimb sequence: Pull Up -> Latch On -> Climb Prep -> Stow. Ends when climber reaches state of climb prep
     */
     ...
     * @param climber
     * @param state
     * @return A command that goes to the specified state, holds it until the command is interrupted, and then stops the climber
     */
     ...
     * @param climber
     * @param state
     * @return A command that holds the specified state until the command is interrupted, and then stops the climber
     */
     ...
     * @param climber
     * @return A command that holds the chainsaw down until the command is interrupted, and then stops the climber
     */
     ...
     * @param climber
     * @return A command that holds the chainsaw up until the command is interrupted, and then stops the climber
     */
