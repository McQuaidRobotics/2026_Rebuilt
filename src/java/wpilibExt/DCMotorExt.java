...
public class DCMotorExt extends DCMotor {
    ...
    /**
     * Calculates the maximum stator current of the motor at a given speed, input voltage and
     * current limits.
     *
     * @param speedRadPerSec The current angular velocity of the motor.
     * @param voltageInput The voltage applied to the motor.
    ...
    public double getCurrent(
        ...
        return Math.min(Math.abs(normalStator), Math.abs(limitedStator))
                * Math.signum(normalStator);
    }
    ...
    /**
     * Calculates the supply current of the motor at a given speed, input voltage and stator
     * current.
     *
     * @param speed The current angular velocity of the motor.
     * @param voltageInput The voltage applied to the motor.
