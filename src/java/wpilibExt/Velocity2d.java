...
public class Velocity2d implements Interpolatable<Velocity2d>, StructSerializable {
    ...
    /**
     * Constructs a Velocity2d from the provided velocity vector's X and Y components. The values
     * are assumed to be in meters per second.
     *
     ...
     * </pre>
     *
     * <p>For example, rotating a Velocity2d of &lt;2, 0&gt; by 90 degrees will return a Velocity2d
     * of &lt;0, 2&gt;.
     *
