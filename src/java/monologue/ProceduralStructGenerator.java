...
public final class ProceduralStructGenerator {
     ...
     * @param override Whether to override an existing struct. An existing struct could mean the
     *     type already has a {@code struct} field and implemnts {@link StructSerializable} or that
     *     the type is already in the custom struct map.
     */
    ...
    /**
     * Returns a byte array of the given size with the given string at the beginning. If the string
     * is longer than the size, it will be truncated. If the string is shorter than the size, the
     * rest of the array will be filled with spaces.
     *
        ...
        public static StructField fromNameAndClass(
            ...
            if (clazz.isArray() && arraySize.isPresent()) {
                ...
                return new StructField(
                        ...
                        (buffer, value) ->
                                buffer.putDouble(((Measure<?>) value).baseUnitMagnitude()));
    ...
    public static class SchemaBuilder {
        ...
        public static final class EnumFieldBuilder {
            ...
            /**
             * Builds the enum field. If this object is being used with {@link
             * SchemaBuilder#addEnumField} then {@link #build()} does not have to be called by the
             * user.
             *
    ...
    public static class SerdePair<A, B> extends Pair<A, B> {
        ...
        public static <A extends StructSerializable, B extends StructSerializable>
                SerdePair<A, B> of(A a, B b) {
            return new SerdePair<>(a, b);
        }

        public static <A extends Measure<?>, B extends Measure<?>> SerdePair<A, B> ofMeasure(
                A a, B b) {
            return new SerdePair<>(a, b);
        }
    }
