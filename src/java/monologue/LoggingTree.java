...
public class LoggingTree {
    ...
    public static class ValueNode extends LoggingNode {
        ...
        public ValueNode(
            ...
            if (StructSerializable.class.isAssignableFrom(type)) {
                this.struct =
                        ProceduralStructGenerator.extractClassStructDynamic(type)
                        ...
                        MonologueEntry.create(
                                ...
                                struct.orElseGet(
                                        () -> {
                                            ...
                                            return ProceduralStructGenerator.noopStruct(
                                                    Object.class);
                                        }),
                                sink);
            } else {
    ...
    public static class ObjectNode extends ComposableNode {
        ...
        private ObjectNode(
                String path, Function<Object, Object> getter, HashSet<Class<?>> seenTypes) {
            super(path);
            this.getter = getter;
            this.err = path + " is null";
    ...
    public static class ObjectArrayNode extends ComposableNode {
        ...
        public void addChild(LoggingNode child) {
            ...
            for (int i = 0; i < indexNodes.size(); i++) {
                indexNodes
                        .get(i)
                        .addChild(child.withNewPath(getPath() + "/" + i + child.getPath()));
            }
        }
    ...
    public static class OptionalNode extends ObjectNode {
        ...
        @SuppressWarnings("unchecked")
        public OptionalNode(
                String path, LogSink sink, Function<Object, Object> getter, Class<?> type) {
