...
public class MonoSendableLayer {
    ...
    static class Builder implements SendableBuilder {
        ...
        public void addBooleanProperty(
                String key, BooleanSupplier getter, BooleanConsumer _setter) {
            if (getter == null) return;
            sendable.addUpdatable(
                    new Runnable() {
                        MonologueBooleanEntry entry =
                                MonologueEntry.createBoolean(path + "/" + key, sink);
        ...
        public void addIntegerProperty(String key, LongSupplier getter, LongConsumer _setter) {
            ...
            sendable.addUpdatable(
                    new Runnable() {
                        MonologueLongEntry entry =
                                MonologueEntry.createLong(path + "/" + key, sink);
        ...
        public void addDoubleProperty(String key, DoubleSupplier getter, DoubleConsumer _setter) {
            ...
            sendable.addUpdatable(
                    new Runnable() {
                        MonologueDoubleEntry entry =
                                MonologueEntry.createDouble(path + "/" + key, sink);
    ...
    static class NtSendableCompat {
        ...
        static {
            ...
            try {
                MethodHandles.Lookup field2dLookup =
                        MethodHandles.privateLookupIn(Field2d.class, lookup);
                ...
                field2dObjectName =
                        fieldObjectLookup.findVarHandle(
                                FieldObject2d.class, "m_name", String.class);
                field2dObjectPoses =
                ...
                mechanism2dDims =
                        mechanism2dLookup.findVarHandle(
                                Mechanism2d.class, "m_dims", double[].class);
                mechanism2dColor =
                        mechanism2dLookup.findVarHandle(Mechanism2d.class, "m_color", String.class);
                mechanism2dRoots =
                        mechanism2dLookup.findVarHandle(Mechanism2d.class, "m_roots", Map.class);
                mechanism2dRootX =
                        rootLookup.findVarHandle(MechanismRoot2d.class, "m_x", double.class);
                mechanism2dRootY =
                        rootLookup.findVarHandle(MechanismRoot2d.class, "m_y", double.class);
                mechanism2dLigamentAngle =
                        ligamentLookup.findVarHandle(
                                MechanismLigament2d.class, "m_angle", double.class);
                mechanism2dLigamentColor =
                        ligamentLookup.findVarHandle(
                                MechanismLigament2d.class, "m_color", String.class);
                mechanism2dLigamentLength =
                        ligamentLookup.findVarHandle(
                                MechanismLigament2d.class, "m_length", double.class);
                mechanism2dLigamentWeight =
                        ligamentLookup.findVarHandle(
                                MechanismLigament2d.class, "m_weight", double.class);
                mechanism2dObjects =
        ...
        public static void addMechanism2dLigament(
            ...
            sendable.addUpdatable(
                    new Runnable() {
                        MonologueDoubleEntry angleEntry =
                                MonologueEntry.createDouble(path + "/angle", sink);
                        MonologueEntry<String> colorEntry =
                                MonologueEntry.create(path + "/color", String.class, sink);
                        MonologueDoubleEntry lengthEntry =
                                MonologueEntry.createDouble(path + "/length", sink);
                        MonologueDoubleEntry weightEntry =
                                MonologueEntry.createDouble(path + "/weight", sink);
        ...
        public static void addMechanism2dRoot(
            ...
            sendable.addUpdatable(
                    new Runnable() {
                        MonologueDoubleEntry xEntry =
                                MonologueEntry.createDouble(path + "/x", sink);
                        MonologueDoubleEntry yEntry =
                                MonologueEntry.createDouble(path + "/y", sink);
        ...
        public static void addMechanism2d(String path, Mechanism2d mech, LogSink sink) {
            ...
            sendable.addUpdatable(
                    new Runnable() {
                        ...
                        MonologueEntry<String> colorEntry =
                                MonologueEntry.create(
                                        path + "/backgroundColor", String.class, sink);
